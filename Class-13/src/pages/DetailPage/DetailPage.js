                        ...
                        {menuItems.map((item) => (
                            <div className="menu-item" key={item?.id}>
                                ...
                                <div className="menu-img-wrapper">
                                    ...
                                    <div className="btns" style={{display:"flex" , width:'100%' , marginTop:'1.2rem' , justifyContent:"center"}}>
                                        <button style={{width:"50px", marginRight:"1rem"}} onClick={()=>handleAdd(item)} >+</button>
